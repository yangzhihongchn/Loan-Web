...
//我要借入导航鼠标事件
				...
				$('.borrow_in_bg').on({
					mouseover:function(){
						...
						$('header').find('li').eq(2).find('span').attr('class','ul-img');
					},
					
					mouseout:function(){
						$(this).css('display','none');
						$('header').find('li').eq(2).find('span').attr('class','');
					}
				})
				
//我要借出导航鼠标事件
				$('header').find('li').eq(1).on({
					mouseover:function(){
				...
				$('.lend_out_bg').on({
					mouseover:function(){
						$(this).css('display','block');
						$('header').find('li').eq(1).find('span').attr('class','ul-img');
					},
					
					mouseout:function(){
						$(this).css('display','none');
						$('header').find('li').eq(1).find('span').attr('class','');
					}
				})
